...
public class Product {
      ...
      public void setReadImage(byte[] readImage)
      {
		...
		public String toString() {
			return "Product [proId=" + proId + ", proName=" + proName + ", proPrice=" + proPrice + ", proBrand="
					+ proBrand + ", proMadeIn=" + proMadeIn + ", proMfgDate=" + proMfgDate + ", proExpDate="
					+ proExpDate + ", proImage=" + proImage + "]";
		}
